...
.outer-table {width:800px!important;max-width:800px!important;}
/* data-inner-table="780 - 540" */
.inner-table {width:600px!important;max-width:600px!important;}
/*Responsive-Tablet*/
...
<body id="body" data-bgcolor="Body" style="margin-top: 0; margin-bottom: 0; padding-top: 0; padding-bottom: 0; width: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; background-color: rgb(244, 244, 244);" bgcolor="#F4F4F4">
...
<div data-primary-font="Verana" data-secondary-font="Roboto" style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;"></div>
...
<table border="0" align="center" cellpadding="0" cellspacing="0" width="100%" style="width:100%;max-width:100%;">
  <tr><!-- Outer Table -->
    <td align="center" data-bgcolor="Body" bgcolor="#F4F4F4" data-composer>
      ...
      <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="800" style="width:800px;max-width:800px;" data-module="madeline-header">
        <!-- madeline-header -->
        <tr>
          <td align="center" bgcolor="#FFFFFF" data-bgcolor="BgColor" class="container-padding">

            <!-- Content -->
            <table data-inner-table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="inner-table row" width="600" style="width:600px;max-width:600px;">
              <tr>
                <td height="40" style="font-size:40px;line-height:40px;" data-height="Spacing top">&nbsp;</td>
              </tr>
              <tr data-element="madeline-logo" data-label="Logo">
                <td align="center" class="center-text">

                  <!--------------------------------------------------------------------------------------------------------------->
                  <a href="https://www.matiasgfernandez.com" target="_blank">
                      <img
                        style="width:180;border:0px;display: inline!important;"
                        src="https://matiasgfernandez.com/public/img/logo/logo.png" width="180" border="0" editable="true"
                        data-icon data-image-edit data-url data-label="Logo" data-image-width alt="logo"
                      >
                  </a>
                  <!--------------------------------------------------------------------------------------------------------------->
      ...
      <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="800" style="width:800px;max-width:800px;" data-module="madeline-preface-1">
        <!-- madeline-preface-1 -->
        <tr>
          <td align="center" bgcolor="#FFFFFF" data-bgcolor="BgColor" class="container-padding"></td>
        </tr>
        <!-- madeline-preface-1 -->
      </table>
      ...
      <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="800" style="width:800px;max-width:800px;" data-module="madeline-preface-2">
        <!-- madeline-preface-2 -->
        <tr>
          <td align="center" bgcolor="#FFFFFF" data-bgcolor="BgColor" class="container-padding">
          ...
          <table data-inner-table border="0" align="center" cellpadding="0" cellspacing="0" class="inner-table row" role="presentation" width="600" style="width:600px;max-width:600px;">
            <tr>
              <td align="center">
                ...
                <!-- Content -->
                <table border="0" align="center" cellpadding="0" cellspacing="0" class="row" role="presentation" width="480" style="width:80%;max-width:80%;">
                  <tr>
                    <td height="40" style="font-size:40px;line-height:40px;" data-height="Spacing top">&nbsp;</td>
                  </tr>


                  <tr data-element="madeline-preface-2-subline" data-label="Sublines">
                    <td class="center-text" data-text-style="Sublines" align="center" style="font-family:'Verana',Arial,Helvetica,sans-serif;font-size:14px;line-height:28px;font-weight:400;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;">
                        <singleline>
                  ...
                  <tr data-element="madeline-preface-2-headline" data-label="Headlines">
                    <td class="center-text" data-text-style="Headlines" align="center" style="font-family:'Verana',Arial,Helvetica,sans-serif;font-size:36px;line-height:42px;font-weight:300;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;">
                        <singleline>
                          <div mc:edit data-text-edit>
                            2021 Fashion Trends
                          </div>
                  ...
                  <tr data-element="madeline-preface-2-paragraph" data-label="Paragraphs">
                    <td class="center-text container-padding" data-text-style="Header Paragraph" align="center" style="font-family:'Verana',Arial,Helvetica,sans-serif;font-size:14px;line-height:26px;font-weight:400;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;">
                        <singleline>
                          <div mc:edit data-text-edit>
                  ...
                  <tr data-element="madeline-preface-2-paragraph" data-label="Paragraphs">
                    <td height="30" style="font-size:30px;line-height:30px;" data-height="Spacing under headlines">&nbsp;</td>
                  </tr>


                  <tr data-element="madeline-preface-2-ghost-buttons" data-label="Ghost Buttons">
                    <td align="center">
                      <!-- Align 
                      <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="center-float">
                        <tr>
                          <td align="center" data-border-radius-default="0,6,36" data-border-radius-custom="Ghost Buttons" data-border-color="Ghost Buttons" style="border:3px solid #000000;border-radius:0px;">
                      <!--[if (gte mso 9)|(IE)]>
                        <table border="0" cellpadding="0" cellspacing="0" align="center">
                          <tr>
                            <td align="center" width="37"></td>
                            <td align="center" height="42" style="height:42px;">
                            <![endif]-->
                              <singleline>
                                <a href="#" mc:edit data-button data-text-style="Ghost Buttons" style="font-family:'Verana',Arial,Helvetica,sans-serif;font-size:16px;line-height:24px;font-weight:800;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;padding: 12px 37px 12px 37px;display: inline-block;"><span>WATCH NOW</span></a>
                              </singleline>
                            <!--[if (gte mso 9)|(IE)]>
                            </td>
                            <td align="center" width="37"></td>
      ...
      <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="800" style="width:800px;max-width:800px;" data-module="madeline-footer">
        <!-- madeline-footer -->
        <tr>
          <td align="center" bgcolor="#FFFFFF" data-bgcolor="BgColor">
            ...
            <table data-inner-table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="inner-table row" width="600" style="width:600px;max-width:600px;">
              ...
              <tr data-element="madeline-footer-headline" data-label="Headlines">
                <td align="center" class="img-responsive">
                  <img class="auto-width" style="display:block;width:100%;max-width:100%;border:0px;" data-image-edit data-url data-label="Picture" width="600" src="images/footer.jpg" border="0" editable="true" alt="picture">
                </td>
              </tr>

              <tr data-element="madeline-footer-buttons" data-label="Footer Buttons">
                <td height="40" style="Font-size:40px;line-height:40px;" data-height="Spacing under buttons">&nbsp;</td>
              </tr>
              <tr data-element="madeline-logo" data-label="Logo">
                <td align="center" class="center-text">
                  <img style="width:160px;border:0px;display: inline!important;" src="https://matiasgfernandez.com/public/img/logo/logo.png" width="160" border="0" editable="true" data-icon data-image-edit data-url data-label="Logo" data-image-width alt="logo">
                </td>
              </tr>
              <tr data-element="madeline-footer-paragraph" data-label="Paragraphs">
                <td height="30" style="font-size:30px;line-height:30px;" data-height="Spacing under paragraphs">&nbsp;</td>
              </tr>

              <!------------------------------------------------------------------------------------------------------------------------------->
              <!------------------------------------------------------------------------------------------------------------------------------->
              <!------------------------------------------------------------------------------------------------------------------------------->
              <tr data-element="madeline-footer-social-icons" data-label="Social Icons">
                <td align="center">
                  <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                    <tr class="center-on-mobile">
                      
                      <td data-element="madeline-footer-linkedin" data-label="Linkedin" class="rwd-on-mobile" align="center" valign="middle">
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                      ...
                      <td data-element="madeline-footer-youtube" data-label="YouTube" class="rwd-on-mobile" align="center" valign="middle">
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                            <td width="7" class="hide-mobile"></td>
                            <td align="center">
              ...
              <tr data-element="madeline-footer-social-icons" data-label="Social Icons">
                <td height="30" style="font-size:30px;line-height:30px;" data-height="Spacing under social Icons">&nbsp;</td>
              </tr>
              <!------------------------------------------------------------------------------------------------------------------------------->
              <!------------------------------------------------------------------------------------------------------------------------------->
              <tr data-element="madeline-footer-tags" data-label="Tags">
                <td data-text-style="Tags" align="center" style="font-family:'Verana',Arial,Helvetica,sans-serif;font-size:13px;line-height:24px;font-weight:400;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;">
                  
                  <a 
                    href="https://www.matiasgfernandez.com" target="_blank"
                    style="font-family:'Verana',Arial,Helvetica,sans-serif;font-size:13px;font-weight:400;line-height:24px;color:#000000;text-decoration:none;">
                      Website
                  </a> 
                    
                  <a 
                      href="https://www.matiasgfernandez.com#blog" target="_blank" 
                      style="font-family:'Verana',Arial,Helvetica,sans-serif;font-size:13px;font-weight:400;line-height:24px;color:#000000;text-decoration:none;">
                       - Blog -  
                  </a> 

                  <a 
                      href="https://www.matiasgfernandez.com#about" target="_blank"
                      style="font-family:'Verana',Arial,Helvetica,sans-serif;font-size:13px;font-weight:400;line-height:24px;color:#000000;text-decoration:none;">
                      Acerca de mi
                  </a>
              ...
              <!------------------------------------------------------------------------------------------------------------------------------->
              <tr data-element="madeline-footer-tags" data-label="Tags">
                <td height="30" style="font-size:30px;line-height:30px;" data-height="Spacing between tags & copyrights">&nbsp;</td>
              </tr>
              <tr data-element="madeline-footer-copyrights" data-label="Copyrights">
                <td data-text-style="Copyrights" align="center" style="font-family:'Verdana',Arial,Helvetica,sans-serif;font-size:13px;line-height:26px;font-weight:400;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;">
                    <singleline>
                      <div mc:edit data-text-edit>
                        2023 Matías Fernández.
                      </div>
                    </singleline>
                </td>
              </tr>
