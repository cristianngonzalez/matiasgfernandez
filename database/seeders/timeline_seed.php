...
class timeline_seed extends Seeder{
    ...
    public function run(){
        ...
        Timeline::create([
            ...
            'icon' => 'img/partners/boehringer_ingelheim.svg',
            'category' => 'startup',
        ...
        Timeline::create([
            ...
            'icon' => 'img/partners/aguas-argentinas.svg',
            'category' => 'company',
        ...
        Timeline::create([
            ...
            'icon' => 'img/partners/fundacion-andina.png',
            'category' => 'startup',
