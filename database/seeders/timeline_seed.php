...
class timeline_seed extends Seeder{
    ...
    public function run(){
        ...
        Timeline::create([
            ...
            'icon' => 'https://www.matiasgfernandez.com/public/img/partners/tga.svg',
            'category' => 'startup',
        ...
        Timeline::create([
            ...
            'icon' => 'https://www.matiasgfernandez.com/public/img/partners/togout.png',
            'category' => 'company',
        ...
        Timeline::create([
            ...
            'icon' => 'https://www.matiasgfernandez.com/public/img/partners/wimet.png',
            'category' => '',
        ...
        Timeline::create([
            ...
            'icon' => 'https://www.matiasgfernandez.com/public/img/partners/molinos.png',
            'category' => 'company',
            'date' => ''
        ]);
        ...
        Timeline::create([
            ...
            'icon' => 'https://www.matiasgfernandez.com/public/img/partners/boehringer_ingelheim.svg',
            'category' => 'startup',
        ...
        Timeline::create([
            ...
            'icon' => 'https://www.matiasgfernandez.com/public/img/partners/p&g.svg',
            'category' => 'startup',
            'date' => 'Ene 2008 - Ene 2014'
        ]);
        ...
        Timeline::create([
            ...
            'icon' => 'https://www.matiasgfernandez.com/public/img/partners/aguas-argentinas.svg',
            'category' => 'company',
        ...
        Timeline::create([
            ...
            'icon' => 'https://www.matiasgfernandez.com/public/img/partners/fundacion-andina.png',
            'category' => 'startup',
